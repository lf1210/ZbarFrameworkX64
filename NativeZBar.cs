...
namespace ZBar
{
    internal  class NativeZBar
    {
        private const string DllName = "lib\\zbar\\win-x64\\libzbar-0.dll";
        ...
        /// </summary>
        /// <returns> 如果成功，则为0；如果发生错误，则为-1</returns>
        [DllImport(DllName)]
        ...
        /// </summary>
        /// <returns>文件描述符或-1（如果视频设备未打开）或者驱动程序仅支持v4l1</returns>
        [DllImport(DllName)]
